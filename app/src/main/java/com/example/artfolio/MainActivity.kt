...
//                showArtistProfile(userEmail ?: "")
//            } else {
//                // For buyer, only update profile picture
//                pickProfileImageLauncher.launch("image/*")
//            }
//        }
//
//        if (userType == "buyer") {
//            findViewById<LinearLayout>(R.id.buyerContainer).visibility = View.VISIBLE
//            recyclerView.visibility = View.GONE
//            setupViewPager()
//        } else {
//            findViewById<LinearLayout>(R.id.buyerContainer).visibility = View.GONE
...
//                }
//            },
//            wishlistIds = emptyList() // For artists, wishlist IDs are not relevant
//        )
//        recyclerView.adapter = adapter
//        loadArtworks()
//    }
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadProfileDetails(email: String) {
        val (bio, socialMedia, _) = dbHelper.getUserProfile(email)
        profileBio.text = "${bio ?: "Not set"}"
        profileSocialMedia.text = "${socialMedia ?: "Not set"}"
    }
